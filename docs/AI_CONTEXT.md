...
- 最新 candidate：`v0.0.6.3-candidate`
- 最新 candidate commit：`8ef174b7eff9984ec4a392e05f93f78534c534da`
- `v0.0.6.3-candidate` 已冻结并推送，指向 `8ef174b7eff9984ec4a392e05f93f78534c534da`；正式 tag `v0.0.6.3` 未创建。
- 最新 main：本轮 docs commit 是 `v0.0.6.3-candidate` 之后的状态同步 commit，提交后以 `git log -1` 为准。
