...
当前 verified baseline：latest main 为 `3597078 chore: add ingredient composition tags`，该 commit 已推 main；新对话继续前应先确认 branch 为 `main`、working tree clean、HEAD 与 `origin/main` 一致。
