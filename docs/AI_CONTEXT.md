...
- 最新 candidate：`v0.0.7.18-candidate`
- 最新 candidate commit：`a9c17811854ee37be540627705bd8ca9b54b55b6`
- `v0.0.7.18-candidate` 已冻结并推送，指向 `a9c17811854ee37be540627705bd8ca9b54b55b6`；正式 tag `v0.0.7.18` 未创建。
- 最新 main：本轮 docs 状态同步 commit 是 `v0.0.7.18-candidate` 之后的状态同步 commit，提交后以 `git log -1` 为准。
