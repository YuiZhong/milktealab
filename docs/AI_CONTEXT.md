...
- 最新确认 candidate：`v0.0.7.63-candidate`
- 最新确认 candidate commit：`2d595661d2972c86892a324645a674f026fc1a54`
- `v0.0.7.63-candidate` 已创建并推送成功，指向 `2d595661d2972c86892a324645a674f026fc1a54`。
- main / origin/main 已在 v0.0.7.63 candidate 冻结时同步到 `2d595661d2972c86892a324645a674f026fc1a54`。
- golden samples 当前应为 `23/23 passed`。
- `git diff --check` 已通过。
- 正式 tag `v0.0.7.63` 未创建。
- 当前未创建 `v0.0.7.64-candidate`。
