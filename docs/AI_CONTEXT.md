...
- 最新 candidate：`v0.0.7.3-candidate`
- 最新 candidate commit：`0a7c6331440c95195f931f776c79a31abfda1f96`
- `v0.0.7.3-candidate` 已冻结并推送，指向 `0a7c6331440c95195f931f776c79a31abfda1f96`；正式 tag `v0.0.7.3` 未创建。
- 最新 main：本轮 docs 状态同步 commit 是 `v0.0.7.3-candidate` 之后的状态同步 commit，提交后以 `git log -1` 为准。
