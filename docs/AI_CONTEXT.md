...
- 最新 candidate：`v0.0.6.10-candidate`
- 最新 candidate commit：`b8ed079b89e90b282a69a96559ca61f5fc53e7f0`
- `v0.0.6.10-candidate` 已冻结并推送，指向 `b8ed079b89e90b282a69a96559ca61f5fc53e7f0`；正式 tag `v0.0.6.10` 未创建。
- 最新 main：本轮 docs commit 是 `v0.0.6.10-candidate` 之后的状态同步 commit，提交后以 `git log -1` 为准。
