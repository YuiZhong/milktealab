...
- 最新 candidate：`v0.0.7.28-candidate`
- 最新 candidate commit：`b94294097a5a3dfe2f5faa5e199fbd3927e82478`
- `v0.0.7.28-candidate` 已冻结并推送，指向 `b94294097a5a3dfe2f5faa5e199fbd3927e82478`；正式 tag `v0.0.7.28` 未创建。
