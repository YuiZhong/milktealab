...
>
> 当前 v0.0.7.x safe closure discussion / closure checkpoint preparation 下，本文件仍是 active stage TODO；但它不是长期正本，阶段结束后必须移出长期必读。
>
...
本文件当前是 v0.0.7.x safe closure discussion / closure checkpoint preparation 下的 active stage TODO；v0.0.7.x 完结后必须移出长期必读列表。

它不是长期正本。当前处于 v0.0.7.x safe closure discussion / closure checkpoint preparation 时，它可以作为阶段内必读；v0.0.7.x 完结后应移出长期必读列表。
...
P0 docs recovery / pause mode 已结束。当前项目处于 v0.0.7.x safe closure discussion / closure checkpoint preparation。
...
## Safe closure discussion / closure checkpoint preparation

当前 safe closure discussion / closure checkpoint preparation 目标：
...
- P0：P0-A / P0-B / P0-C 已解决，项目从 P0 docs recovery / pause mode 转入 v0.0.7.x safe closure discussion / closure checkpoint preparation。
